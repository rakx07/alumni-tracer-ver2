{{-- resources/views/itadmin/strands/edit.blade.php --}}
<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div>
                <h2 class="font-extrabold text-xl text-gray-900">Edit Strand</h2>
                <p class="text-sm text-gray-600">Update strand details and status.</p>
            </div>
    ...
    <div class="py-8" style="background:var(--page);">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="strip">
                <div class="strip-top">
                    <div class="strip-left">
                        ...
                        <div class="min-w-0">
                            <div class="strip-title">Strand Information</div>
                            <div class="strip-sub">Edit code, name, and activation status.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-4">
                    <form method="POST"
                          action="{{ route('itadmin.strands.update', $strand) }}"
                          class="space-y-4">
                        @csrf
                        @method('PUT')
            ...
            <div class="text-xs text-gray-500">
                Tip: Disabling a strand hides it from selection but keeps historical records intact.
            </div>
