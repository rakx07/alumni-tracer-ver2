        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(in_array(auth()->user()->role, ['alumni_officer','it_admin']))
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        {{-- ✅ IMPORTANT: Profile link removed because profile.edit route does not exist --}}
                        {{-- You can add profile routes later if you want. --}}
