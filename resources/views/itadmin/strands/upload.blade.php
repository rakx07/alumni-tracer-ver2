<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800">Upload Strands</h2>
    ...
    <div class="py-8 max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-4">
        ...
        <div class="bg-white border rounded p-6 text-sm">
            ...
            <div class="font-mono bg-gray-50 border rounded p-3">code,name,is_active</div>
            <div class="text-xs text-gray-600 mt-2">
                is_active: 1 or 0
            </div>
        </div>

        <form method="POST" enctype="multipart/form-data" action="{{ route('itadmin.strands.upload') }}" class="bg-white border rounded p-6 space-y-3">
            @csrf
            <div>
